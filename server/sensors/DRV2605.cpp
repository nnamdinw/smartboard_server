...
// I2C, no address adjustments or pins
	DRV2605::DRV2605() 
	{
		setFd(wiringPiI2CSetup(DRV2605_ADDR));
	}

	void DRV2605::setFd(int a)
	{
		i2cfd = a;
	}
...
/**************************************************************************/
 ...
 unsigned char DRV2605::readRegister8(unsigned char regAddr)
 {
  unsigned char data;
...
{
  wiringPiI2CWriteReg8(getFd(),reg,val);
